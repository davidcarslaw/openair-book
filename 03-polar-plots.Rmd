...
```{r polarPlot2,fig.width=5,fig.height=5,cache=TRUE,fig.cap='Example plots using the `polarPlot` function with different options for the mean concentration of NO~x~.'}
## NOx plot
...
```{r polarPlot3,fig.width=5,fig.height=5,fig.cap='Example plots using the `polarPlot` function for the mean concentration of SO~2~.'}
...
```{r polarRatio,fig.width=5,fig.height=5,fig.cap='Bivariate polar plot of the ratio of SO~2~/NO~x~.'}
...
```{r polarNWR,fig.width=5,fig.height=5,fig.cap='`polarPlot` of SO~2~ concentrations at Marylebone Road based on the NWR approach.'}
...
```{r polarPlotCPF,fig.width=5,fig.height=5,fig.cap='`polarPlot` of SO~2~ concentrations at Marylebone Road based on the CPF function.'}
polarPlot(mydata, 
          pollutant = "so2", 
          statistic = "cpf", 
          percentile = 90)
...
```{r polarPlotCPFInt,fig.width=4.5,fig.height=4,fig.show='hold',fig.cap='`polarPlot` of SO~2~ concentrations at Marylebone Road based on the CPF function for a range of percentile intervals from 0--10, 10--20, ... , 90--100.'}
...
```{r polarPair,fig.width=5,fig.height=5,fig.cap='Use of the `polarPlot` function to investigate the linear regression slope between PM~2.5~ and PM~10~ at Harwell in 2013. In this case the robust slope is calculated.'}
...
```{r polarClustn6,fig.width=5,fig.height=5,fig.keep='last',fig.cap='Use of the `polarCluster` function applied to SO~2~ concentrations at Marylebone Road. In this case 8 clusters have been chosen.'}
