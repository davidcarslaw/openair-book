...
($\mu$g m^-3^) and is marked as 'observed' on the x-axis. The magnitude of
...
deviation for model $g$, which is about 25~$\mu$g m^-3^). To aid interpretation
...
of about 20~$\mu$g m^-3^, shown again by the red line. Models $e$ and $i$ are
considerably worse because they have RMS errors of around 30~$\mu$g m^-3^.
...
20--22~$\mu$g m^-3^). Models 3, 5 and 6 tend to do worse on all three
