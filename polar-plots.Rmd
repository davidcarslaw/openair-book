...
This Section considers the flexible `polarPlot` function that is used to provide information about source characteritics. The clustering of polar plots is also considered using `polarCluster`.
