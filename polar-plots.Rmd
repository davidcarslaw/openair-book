...
The function is called as shown in Figure \@ref(fig:polarClust-diff). Note that the output is recorded in `clust_out`.

```{r polarClust-diff,fig.width=5,fig.height=4.5,fig.keep='last',fig.cap='A difference plot for PM~10~ concentrations at Port Talbot between 2012 and 2019.'}
