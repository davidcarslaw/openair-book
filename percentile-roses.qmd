...
A slightly more interesting plot is shown in @fig-percentileRoseSO2 for SO~2~ concentrations. We also
...
shown in @fig-percentileRoseCPF. Note that in these plots
only one percentile is provided and the method must be supplied. In @fig-percentileRoseCPF it is clear that the high
