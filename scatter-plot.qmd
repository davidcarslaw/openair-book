...
@fig-scatterPlot5 shows that `scatterPlot` can also handles dates on the x-axis; in this case shown for SO~2~ concentrations coloured by wind direction for August 2003.
