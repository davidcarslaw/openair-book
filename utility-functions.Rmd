...
```{r RunningRes,fig.width=8,fig.height=5,out.width='80%',fig.cap='Example of using the `selectRunning` function to select episode hours to produce bivariate polar plots of O~3~ concentration.'}
polarPlot(ted, pollutant = "o3", 
          min.bin = 2, 
          type = "criterion")
```
