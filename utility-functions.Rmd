...
roughly equal numbers of PM_10~ concentrations in four levels.

Most of the time users do not have to call `cutData` directly
because most functions have a `type` option that is used to call
