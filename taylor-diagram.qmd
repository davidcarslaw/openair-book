...
diagram is shown in @fig-TaylorExam for nine anonymised
...
shown by the top-right Figure in @fig-TaylorPlots.  This is
...
Finally, the lower plot in @fig-TaylorPlots highlights the
...
@fig-TaylorSeas contains a lot of useful
...
variation by model for *all* sites. The results are shown in @fig-Taylor2Grp. These results show that in general models
tend to predict in similarly good (or bad) ways across all sites as
shown by the grouping of points on @fig-Taylor2Grp. 
