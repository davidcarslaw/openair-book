# Temporal variations {#timeVariation}


## Purpose {#purpose-time-var}
...
-  The function works well in conjunction with other functions
  such as `polarPlot` (see Section \@ref(polarPlot)), where the latter may identify conditions
...
(Section \@ref(polarPlot)) is very useful in this respect in highlighting
