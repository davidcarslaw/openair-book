...
each day in 2003 (@fig-calendarPlot). Note that if `year`
...
@fig-calendarPlotExceed highlights those days where PM~10~
...
@fig-calendarPlotCategor shows an example of plotting data
...
`labels`. In the example in @fig-calendarPlotCategor the
...
given in @fig-calendarPlotCategor the maximum daily
